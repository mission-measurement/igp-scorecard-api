...
const programreportdata = async (
  ...
  typeofdatacollectedlabel, IF(rate, rate * totalbudget, totalbudget) AS totalbudget, 'USD' AS budgetcurrencytype, mminsight, CONCAT(MONTHNAME(programreportdata.created) ," ", YEAR(programreportdata.created)) AS insightdate, inkinddonationsreceived, inkinddonationscurrencytype, inkinddonationsdescription, volunteersused, volunteerhours, volunteerpercentage, 
