...
const programreportdata = async (
  ...
  typeofdatacollectedlabel, totalbudget, budgetcurrencytype, mminsight, CONCAT(MONTHNAME(created) ," ", YEAR(created)) AS insightdate, inkinddonationsreceived, inkinddonationscurrencytype, inkinddonationsdescription, volunteersused, volunteerhours, volunteerpercentage, 
