...
const programreportdata = async (
  ...
  eligibilitycriteria, distancefromlocation, describeoutcomecalculation, 
  CASE WHEN typeofdatacollectedid = 43 THEN 5 WHEN typeofdatacollectedid = 44 THEN 4 WHEN typeofdatacollectedid = 45 THEN 3 WHEN typeofdatacollectedid = 46 THEN 2 WHEN typeofdatacollectedid = 47 THEN 1 ELSE 0 END AS typeofdatacollectedvalue, 
